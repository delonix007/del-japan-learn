    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-6">
          ...
          {exp && (
            <div className="mb-4">
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className="text-gray-500">{exp.total_exp} / {nextExp} EXP</span>
              </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden mb-6">
          <Link href="/premium" className="block p-4 border-b border-gray-50 hover:bg-gray-50 transition-colors">
            <p className="font-medium text-primary">⭐ Upgrade ke Premium</p>
            <p className="text-sm text-gray-500">Akses semua 50 pelajaran</p>
          </Link>
          <Link href="/learn" className="block p-4 border-b border-gray-50 hover:bg-gray-50 transition-colors">
            <p className="font-medium">📚 Lanjut Belajar</p>
            <p className="text-sm text-gray-500">Lanjutin pelajaran terakhir</p>
          </Link>
        </div>
