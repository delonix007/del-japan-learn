...
INSERT INTO quiz_questions (lesson_id, jenis_soal, soal, pilihan_jawaban, jawaban_benar) VALUES
  ...
  (5, 'kuis_bergambar', 'Lihat gambar: 📚 di atas meja.', '["本は机の上にあります。", "本は机の下にあります。", "本は椅子にあります。", "本は床にあります。"]', '本は机の上にあります。')
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (lesson_id, jenis_soal, soal, pilihan_jawaban, jawaban_benar) VALUES
  ...
  (7, 'pasangkan', 'Pasangkan: 勉強/belajar, 日本語/bhs Jepang, 英語/bhs Inggris', NULL, '勉強-benar')
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (lesson_id, jenis_soal, soal, pilihan_jawaban, jawaban_benar) VALUES
  ...
  (9, 'kuis_bergambar', 'Lihat gambar: 🧠💡', '["少し分かります。", "全然分かりません。", "よく分かります。", "分かりました。"]', '少し分かります。')
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (lesson_id, jenis_soal, soal, pilihan_jawaban, jawaban_benar) VALUES
  ...
  (13, 'kuis_bergambar', 'Lihat gambar: 📞🍽️', '["もう予約しましたか。", "何を勉強しますか。", "どこに行きますか。", "いつ来ますか。"]', 'もう予約しましたか。')
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (lesson_id, jenis_soal, soal, pilihan_jawaban, jawaban_benar) VALUES
  ...
  (17, 'kuis_bergambar', 'Lihat gambar: 😟', '["どうしましたか。", "こんにちは。", "ありがとうございます。", "さようなら。"]', 'どうしましたか。')
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (lesson_id, jenis_soal, soal, pilihan_jawaban, jawaban_benar) VALUES
  ...
  (21, 'kuis_bergambar', 'Lihat gambar: 💬❓', '["何と言いましたか。", "何を食べましたか。", "どこに行きましたか。", "いつ来ましたか。"]', '何と言いましたか。')
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (lesson_id, jenis_soal, soal, pilihan_jawaban, jawaban_benar) VALUES
  ...
  (25, 'kuis_bergambar', 'Lihat gambar: 🚶‍♂️❓🗺️', '["どうやって行きますか。", "何を食べますか。", "どこに行きますか。", "いつ来ますか。"]', 'どうやって行きますか。')
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (lesson_id, jenis_soal, soal, pilihan_jawaban, jawaban_benar) VALUES
  ...
  (29, 'kuis_bergambar', 'Lihat gambar: 🚉👋', '["駅まで迎えに行きます。", "駅に行きます。", "駅で食べます。", "駅から帰ります。"]', '駅まで迎えに行きます。')
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (lesson_id, jenis_soal, soal, pilihan_jawaban, jawaban_benar) VALUES
  ...
  (33, 'kuis_bergambar', 'Lihat gambar: 🗺️❓😰', '["道に迷いました。", "道が分かりました。", "家に帰りました。", "駅に着きました。"]', '道に迷いました。')
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (lesson_id, jenis_soal, soal, pilihan_jawaban, jawaban_benar) VALUES
  ...
  (37, 'kuis_bergambar', 'Lihat gambar: 🗾⏰', '["日本にいる間に。", "日本に行きます。", "日本を食べます。", "日本を勉強します。"]', '日本にいる間に。')
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (lesson_id, jenis_soal, soal, pilihan_jawaban, jawaban_benar) VALUES
  ...
  (41, 'kuis_bergambar', 'Lihat gambar: 💬👂', '["意見を聞かせてください。", "意見があります。", "意見をします。", "意見を食べます。"]', '意見を聞かせてください。')
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (lesson_id, jenis_soal, soal, pilihan_jawaban, jawaban_benar) VALUES
  ...
  (45, 'kuis_bergambar', 'Lihat gambar: 📈🇯🇵😊', '["日本語が上手になりましたね。", "日本語を勉強します。", "日本語を食べます。", "日本語に行きます。"]', '日本語が上手になりましたね。')
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (lesson_id, jenis_soal, soal, pilihan_jawaban, jawaban_benar) VALUES
  ...
  (47, 'pasangkan', 'Pasangkan: 留学/belajar di LN, する/melakukan, たい/ingin', NULL, '留学-benar')
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (lesson_id, jenis_soal, soal, pilihan_jawaban, jawaban_benar) VALUES
  ...
  (49, 'kuis_bergambar', 'Lihat gambar: 🤝➡️', '["これからもよろしく。", "さようなら。", "お元気で。", "ありがとうございました。"]', 'これからもよろしく。')
ON CONFLICT DO NOTHING;
